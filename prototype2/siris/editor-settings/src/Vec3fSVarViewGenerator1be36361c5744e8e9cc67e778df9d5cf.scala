...
class Vec3fSVarViewGenerator1be36361c5744e8e9cc67e778df9d5cf extends SVarViewGenerator[Vec3f] {

  def generate: SVarView[Vec3f] = new SVarView[Vec3f] {
